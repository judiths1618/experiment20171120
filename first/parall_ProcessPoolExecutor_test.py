...
if __name__ == '__main__':
    s = time.time ()
    x1 = [3, 7, 6, 4, 9]  # 1
    x2 = [13, 17, 16, 14, 19]  #10
    x3 = [13, 27, 16, 24, 19]  #100
    x4 = [23, 27, 26, 24, 29]  #20
    x5 = [23, 37, 26, 34, 29]  #200
    x6 = [33, 37, 36, 34, 39]  #30
    x7 = [33, 47, 36, 44, 39]  #300
    x8 = [43, 47, 46, 44, 49]  #40
    x9 = [43, 57, 46, 54, 49]  #400
    x10 = [53, 57, 56, 54, 59]  #50
    x11 = [53, 67, 56, 64, 59]  #500
    x12 = [63, 67, 66, 64, 69]  #60
    x13 = [63, 77, 66, 74, 69]  #600
    x14 = [73, 77, 76, 74, 79]  #70
    x15 = [73, 87, 76, 84, 79]  #700
    x16 = [83, 87, 86, 84, 89]  #80
    x17 = [83, 97, 86, 94, 89]  #800
    x18 = [93, 97, 96, 94, 99]  #90
    x19 = [93, 107, 96, 104, 99]    #900
    x20 = [103, 107, 106, 104, 109] #1000
    X = [x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15]
        # ,x16,x17,x18,x19,x20]
    for k, x in enumerate (X):
        for i in range(1,len(X)+1):
            pos = 'bigscale\\+'+str(k+1)+'\\' + str (i)
            ...
            print ('round ' + pos)
            pre_optimal_assi, task_number, game_stage = pre_optimal_ass (task_pool, V, pos)
            use_submit (pre_optimal_assi, V, pos)
            ...
            filename = '.\\datafile\\bigscale\\curve\\out.dat'
            fa = open (filename, 'a')
