...
##########################$ MAKE DRAW ###############
p.make_svg_for_tasks(filename='.\\datafile\\test_full.svg',
                     today=datetime.date(2014, 12, 31),
                     start=datetime.date(2014,8, 22),
                     end=datetime.date(2015, 1, 14))
p.make_svg_for_tasks(filename='.\\datafile\\test_full2.svg',
                     today=datetime.date(2014, 12, 31))
p.make_svg_for_tasks(filename='.\\datafile\\test.svg',
                     today=datetime.date(2014, 12, 31),
                     start=datetime.date(2015, 1, 3),
                     end=datetime.date(2015, 1, 6))
p1.make_svg_for_tasks(filename='.\\datafile\\test_p1.svg',
                      today=datetime.date(2014, 12, 31))
p2.make_svg_for_tasks(filename='.\\datafile\\test_p2.svg',
                      today=datetime.date(2014, 12, 31))
p.make_svg_for_resources(filename='.\\datafile\\test_resources.svg',
                         today=datetime.date(2014, 12, 31),
                         resources=[rANO, rJLS])
p.make_svg_for_tasks(filename='.\\datafile\\test_weekly.svg',
                     today=datetime.date(2014, 12, 31),
